...
namespace AppBundle\Dominio\PDFMerger\Fpdi\PdfParser;

use AppBundle\Dominio\PDFMerger\Fpdi\PdfParser\CrossReference\CrossReference;
 ...
 * A PDF parser class
 *
 * @package AppBundle\Dominio\PDFMerger\Fpdi\PdfParser
 */
class PdfParser
{
    /**
