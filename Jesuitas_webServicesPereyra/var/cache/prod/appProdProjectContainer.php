...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'db_manager' => 'getDbManagerService',
    ...
    /*
     * Gets the public 'app.token_authenticator' shared service.
     *
     * @return \AppBundle\Security\TokenAuthenticator
     */
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ARhhX9EZ+Y', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ojxn+CKc9M', 0, '-8F+U4+UimV5oQv5zrwXla', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /*
     * Gets the public 'db_manager' shared service.
     *
     * @return \AppBundle\DB\DatabaseManager
     */
    protected function getDbManagerService()
    {
        return $this->services['db_manager'] = new \AppBundle\DB\DatabaseManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '134.209.1.0', 'port' => 8099, 'dbname' => 'testCiencias', 'user' => 'Mpair_658R', 'password' => '2UtQzfLmYL^XNX6n25z3wmPB*hTne5!Jg_PQ*+w5NZ', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->addCustomStringFunction('FIND_IN_SET', 'AppBundle\\DB\\lib\\FindInSet');
        $c->addCustomStringFunction('GroupConcat', 'AppBundle\\DB\\lib\\GroupConcat');
        $c->addCustomStringFunction('DATE_FORMAT', 'AppBundle\\DB\\lib\\DateFormatFunction');
        $c->addCustomStringFunction('LAST_DAY', 'AppBundle\\DB\\lib\\LastDay');
        $c->addCustomStringFunction('calculaInteres', 'AppBundle\\DB\\lib\\InteresDocumento');
        $c->addCustomStringFunction('calculaInteresfecha', 'AppBundle\\DB\\lib\\InteresDocumentoFecha');
        $c->addCustomStringFunction('calculaAdeudo', 'AppBundle\\DB\\lib\\Adeudo');
        $c->addCustomStringFunction('colegiaturasVencidasAlumno', 'AppBundle\\DB\\lib\\ColegiaturasVencidasAlumno');
        $c->addCustomStringFunction('FechaEspanol', 'AppBundle\\DB\\lib\\FechaEspanolFunction');
        $c->addCustomStringFunction('MesEspanol', 'AppBundle\\DB\\lib\\MesEspanolFunction');
        $c->addCustomStringFunction('DiaEspanol', 'AppBundle\\DB\\lib\\DiaEspanolFunction');
        $c->addCustomStringFunction('concat_ws', 'AppBundle\\DB\\lib\\ConcatWs');
        $c->addCustomStringFunction('FIRST', 'AppBundle\\DB\\lib\\FirstFunction');
        $c->addCustomStringFunction('CAST', 'AppBundle\\DB\\lib\\Cast');
        $c->addCustomStringFunction('COLLATE', 'AppBundle\\DB\\lib\\CollateFunction');
        $c->addCustomStringFunction('ROUND', 'AppBundle\\DB\\lib\\Round');
        $c->addCustomStringFunction('strtodate', 'AppBundle\\DB\\lib\\StrToDate');
        $c->addCustomStringFunction('REGEXP', 'AppBundle\\DB\\lib\\RegexFunction');
        $c->addCustomStringFunction('DAYOFWEEK', 'AppBundle\\DB\\lib\\DayOfWeek');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_4b6c7c9fe1ac672c183bcfdd94578ca49297c92d38d4850e57f69245f0135d77');
    ...
    {
        $this->services['fos_rest.view_handler'] = $instance = new \FOS\RestBundle\View\ViewHandler($this->get('router'), $this->get('fos_rest.serializer'), $this->get('templating', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('request_stack'), array('json' => false, 'html' => true), 400, 204, false, array('html' => 302), 'twig');
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'America/Mexico_City', true);
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api/' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600), '^/' => array('origin_regex' => true, 'allow_origin' => array(0 => '^http://localhost:[0-9]+'), 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600, 'hosts' => array(0 => '^api\\.'))), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false, 'forced_allow_origin_value' => NULL));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('Owod6RHTCX', NULL, '-8F+U4+UimV5oQv5zrwXla', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = $this->get('app.token_authenticator');
        ...
        $h->add($g, array(0 => 'ROLE_ADMIN'), 'https');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}), 'main', $a, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $c), 2 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $d, 'main', array(0 => $e), $a), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '60fb36d531f0b2.61938054', $a, $d), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['security.access.decision_manager']) ? $this->services['security.access.decision_manager'] : $this->getSecurity_Access_DecisionManagerService()) && false ?: '_'}, $h, $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $c, new \Symfony\Component\Security\Http\HttpUtils($f, $f), 'main', $e, NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.in_memory', 'main', 'app.token_authenticator', NULL, NULL, array(0 => 'guard', 1 => 'anonymous')));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('erpjesuitas@gmail.com');
        $a->setPassword('0114#1nc3pT10');
        $a->setAuthMode('login');
    ...
    /*
     * Gets the public 'swiftmailer.plugin.impersonate' shared service.
     *
     * @return \Swift_Plugins_ImpersonatePlugin
     */
    protected function getSwiftmailer_Plugin_ImpersonateService()
    {
        return $this->services['swiftmailer.plugin.impersonate'] = new \Swift_Plugins_ImpersonatePlugin('erpjesuitas@gmail.com');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5071660db4ba7978cf01f41e3151efd392bb61a7');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cWIHXdfpO1', 0, '-8F+U4+UimV5oQv5zrwXla', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('us14JFkOW7', 0, '-8F+U4+UimV5oQv5zrwXla', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ebc1SMsNMg', 0, '-8F+U4+UimV5oQv5zrwXla', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('app.token_authenticator')), ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}, 'main', new \Symfony\Component\Security\Core\User\UserChecker()), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('60fb36d531f0b2.61938054')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '134.209.1.0',
            'database_port' => 8099,
            'database_name' => 'testCiencias',
            'database_user' => 'Mpair_658R',
            'database_password' => '2UtQzfLmYL^XNX6n25z3wmPB*hTne5!Jg_PQ*+w5NZ',
            'mailer_transport' => 'gmail',
            'mailer_encryption' => 'ssl',
            'mailer_auth_mode' => 'login',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'erpjesuitas@gmail.com',
            'mailer_password' => '0114#1nc3pT10',
            'mailer_sender_address' => 'erpjesuitas@gmail.com',
            'secret' => '5071660db4ba7978cf01f41e3151efd392bb61a7',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5071660db4ba7978cf01f41e3151efd392bb61a7',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'erpjesuitas@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '0114#1nc3pT10',
            ...
            'swiftmailer.mailer.default.sender_address' => 'erpjesuitas@gmail.com',
            'swiftmailer.sender_address' => 'erpjesuitas@gmail.com',
