 ...
 */
class AdAdmisioncontrato extends \AppBundle\Entity\AdAdmisioncontrato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'extension', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'tamano', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'documento', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontrato' . "\0" . 'contratoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdAdmisioncontrato $proxy) {
    ...
    public function setTamano($tamano)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTamano', [$tamano]);
    ...
    public function getTamano()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTamano', []);
