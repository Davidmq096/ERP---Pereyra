 ...
 */
class AdAdmisioncontratoarchivo extends \AppBundle\Entity\AdAdmisioncontratoarchivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'admisioncontratoid', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'contratoid', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'extension', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AdAdmisioncontratoarchivo' . "\0" . 'admisioncontratoarchivoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdAdmisioncontratoarchivo $proxy) {
    ...
    public function getAdmisioncontratoarchivoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAdmisioncontratoarchivoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdmisioncontratoarchivoid', []);

        return parent::getAdmisioncontratoarchivoid();
    }
