 ...
 */
class AdAdmisiongradoporcontrato extends \AppBundle\Entity\AdAdmisiongradoporcontrato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AdAdmisiongradoporcontrato' . "\0" . 'gradopordocumentoid', '' . "\0" . 'AppBundle\\Entity\\AdAdmisiongradoporcontrato' . "\0" . 'contratoid', '' . "\0" . 'AppBundle\\Entity\\AdAdmisiongradoporcontrato' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdAdmisiongradoporcontrato $proxy) {
    ...
    public function getGradopordocumentoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getGradopordocumentoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradopordocumentoid', []);

        return parent::getGradopordocumentoid();
    }
