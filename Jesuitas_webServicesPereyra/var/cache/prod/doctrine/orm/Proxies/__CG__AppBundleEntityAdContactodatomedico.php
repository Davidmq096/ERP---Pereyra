 ...
 */
class AdContactodatomedico extends \AppBundle\Entity\AdContactodatomedico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'contactoemergencianombre', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'contactoemergenciatelefono', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'contactoemergenciaemail', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'contactoemergenciaparentesco', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'contactodatomedicoid', '' . "\0" . 'AppBundle\\Entity\\AdContactodatomedico' . "\0" . 'datomedicoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdContactodatomedico $proxy) {
    ...
    public function getContactodatomedicoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getContactodatomedicoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContactodatomedicoid', []);

        return parent::getContactodatomedicoid();
    }
