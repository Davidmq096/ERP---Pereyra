 ...
 */
class AdContactoemergencia extends \AppBundle\Entity\AdContactoemergencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'contactoemergenciaid', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'parentescoid', '' . "\0" . 'AppBundle\\Entity\\AdContactoemergencia' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdContactoemergencia $proxy) {
    ...
    public function getContactoemergenciaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getContactoemergenciaid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContactoemergenciaid', []);

        return parent::getContactoemergenciaid();
    }
