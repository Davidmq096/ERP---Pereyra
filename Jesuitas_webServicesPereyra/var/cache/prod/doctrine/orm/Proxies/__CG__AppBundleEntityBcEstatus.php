 ...
 */
class BcEstatus extends \AppBundle\Entity\BcEstatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcEstatus' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcEstatus' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcEstatus' . "\0" . 'estatusid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcEstatus $proxy) {
