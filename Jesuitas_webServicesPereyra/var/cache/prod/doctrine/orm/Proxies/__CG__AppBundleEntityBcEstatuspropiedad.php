 ...
 */
class BcEstatuspropiedad extends \AppBundle\Entity\BcEstatuspropiedad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcEstatuspropiedad' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcEstatuspropiedad' . "\0" . 'instituto', '' . "\0" . 'AppBundle\\Entity\\BcEstatuspropiedad' . "\0" . 'estatusid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcEstatuspropiedad $proxy) {
    ...
    public function setInstituto($instituto)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInstituto', [$instituto]);
    ...
    public function getEstatusid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getEstatusid();
        }
