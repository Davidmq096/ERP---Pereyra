 ...
 */
class BcEstatussolicitudbeca extends \AppBundle\Entity\BcEstatussolicitudbeca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcEstatussolicitudbeca' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcEstatussolicitudbeca' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcEstatussolicitudbeca' . "\0" . 'estatusid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcEstatussolicitudbeca $proxy) {
