 ...
 */
class BcFormatobeca extends \AppBundle\Entity\BcFormatobeca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'nombrearchivo', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'archivo', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'archivosize', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'archivotipo', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'formatobecaid', '' . "\0" . 'AppBundle\\Entity\\BcFormatobeca' . "\0" . 'tipodocumentoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcFormatobeca $proxy) {
    ...
    public function getFormatobecaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getFormatobecaid();
        }
    ...
    public function setTipodocumentoid(\AppBundle\Entity\BcTipodocumento $tipodocumentoid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipodocumentoid', [$tipodocumentoid]);

        return parent::setTipodocumentoid($tipodocumentoid);
    }
    ...
    public function getTipodocumentoid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipodocumentoid', []);

        return parent::getTipodocumentoid();
    }
