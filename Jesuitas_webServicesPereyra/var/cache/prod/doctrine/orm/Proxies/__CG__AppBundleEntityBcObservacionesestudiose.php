 ...
 */
class BcObservacionesestudiose extends \AppBundle\Entity\BcObservacionesestudiose implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcObservacionesestudiose' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\BcObservacionesestudiose' . "\0" . 'observaionesestudioseid', '' . "\0" . 'AppBundle\\Entity\\BcObservacionesestudiose' . "\0" . 'solicitudid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcObservacionesestudiose $proxy) {
    ...
    public function getObservaionesestudioseid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getObservaionesestudioseid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getObservaionesestudioseid', []);

        return parent::getObservaionesestudioseid();
    }
