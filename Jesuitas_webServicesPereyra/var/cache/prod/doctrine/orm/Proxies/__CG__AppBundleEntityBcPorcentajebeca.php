 ...
 */
class BcPorcentajebeca extends \AppBundle\Entity\BcPorcentajebeca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcPorcentajebeca' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcPorcentajebeca' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcPorcentajebeca' . "\0" . 'porcentajebecaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcPorcentajebeca $proxy) {
    ...
    public function getPorcentajebecaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPorcentajebecaid();
        }
