 ...
 */
class BcProvisionalbecas extends \AppBundle\Entity\BcProvisionalbecas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'provisionalbecaid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'estatusid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'gradoid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'porcentajebecaid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'solicitudid', '' . "\0" . 'AppBundle\\Entity\\BcProvisionalbecas' . "\0" . 'tipobecaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcProvisionalbecas $proxy) {
    ...
    public function getProvisionalbecaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getProvisionalbecaid();
        }
