 ...
 */
class BcRecibirdocumentos extends \AppBundle\Entity\BcRecibirdocumentos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcRecibirdocumentos' . "\0" . 'recibirdocumentosid', '' . "\0" . 'AppBundle\\Entity\\BcRecibirdocumentos' . "\0" . 'documentoid', '' . "\0" . 'AppBundle\\Entity\\BcRecibirdocumentos' . "\0" . 'solicitudid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcRecibirdocumentos $proxy) {
    ...
    public function getRecibirdocumentosid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getRecibirdocumentosid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRecibirdocumentosid', []);

        return parent::getRecibirdocumentosid();
    }
