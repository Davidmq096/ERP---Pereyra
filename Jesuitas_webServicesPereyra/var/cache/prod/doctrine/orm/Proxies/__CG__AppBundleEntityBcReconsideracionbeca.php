 ...
 */
class BcReconsideracionbeca extends \AppBundle\Entity\BcReconsideracionbeca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'fechasolicitud', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'motivo', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'estatusid', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'porcentajebecaid', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'reconsideracionbecaid', '' . "\0" . 'AppBundle\\Entity\\BcReconsideracionbeca' . "\0" . 'becaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcReconsideracionbeca $proxy) {
    ...
    public function getReconsideracionbecaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getReconsideracionbecaid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReconsideracionbecaid', []);

        return parent::getReconsideracionbecaid();
    }
