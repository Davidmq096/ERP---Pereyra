 ...
 */
class BcSolicitudbecadictamen extends \AppBundle\Entity\BcSolicitudbecadictamen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'dictamenid', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'porcentajebecaid', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'tipobecaid', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'estatusid', '' . "\0" . 'AppBundle\\Entity\\BcSolicitudbecadictamen' . "\0" . 'solicitudid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcSolicitudbecadictamen $proxy) {
