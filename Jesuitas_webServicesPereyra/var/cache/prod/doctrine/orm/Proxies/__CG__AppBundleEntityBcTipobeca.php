 ...
 */
class BcTipobeca extends \AppBundle\Entity\BcTipobeca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcTipobeca' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcTipobeca' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcTipobeca' . "\0" . 'tipobecaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcTipobeca $proxy) {
    ...
    public function getTipobecaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipobecaid();
        }
