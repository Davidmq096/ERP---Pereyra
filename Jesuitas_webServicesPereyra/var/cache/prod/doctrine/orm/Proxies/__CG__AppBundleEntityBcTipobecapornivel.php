 ...
 */
class BcTipobecapornivel extends \AppBundle\Entity\BcTipobecapornivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcTipobecapornivel' . "\0" . 'afectainscripcion', '' . "\0" . 'AppBundle\\Entity\\BcTipobecapornivel' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcTipobecapornivel' . "\0" . 'tipobecapornivelid', '' . "\0" . 'AppBundle\\Entity\\BcTipobecapornivel' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\BcTipobecapornivel' . "\0" . 'tipobecaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcTipobecapornivel $proxy) {
    ...
    public function setAfectainscripcion($afectainscripcion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAfectainscripcion', [$afectainscripcion]);

        return parent::setAfectainscripcion($afectainscripcion);
    }
    ...
    public function getAfectainscripcion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAfectainscripcion', []);

        return parent::getAfectainscripcion();
    }
    ...
    public function getTipobecapornivelid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipobecapornivelid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipobecapornivelid', []);

        return parent::getTipobecapornivelid();
    }
