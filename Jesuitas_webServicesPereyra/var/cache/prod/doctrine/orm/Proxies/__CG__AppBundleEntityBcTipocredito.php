 ...
 */
class BcTipocredito extends \AppBundle\Entity\BcTipocredito implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcTipocredito' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcTipocredito' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BcTipocredito' . "\0" . 'tipocreditoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcTipocredito $proxy) {
    ...
    public function getTipocreditoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipocreditoid();
        }
