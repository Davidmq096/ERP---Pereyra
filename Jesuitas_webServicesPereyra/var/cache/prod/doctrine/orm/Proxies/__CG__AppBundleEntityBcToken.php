 ...
 */
class BcToken extends \AppBundle\Entity\BcToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'token', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'preescolar', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'primaria', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'secundaria', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'bachillerato', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\BcToken' . "\0" . 'tokenid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BcToken $proxy) {
