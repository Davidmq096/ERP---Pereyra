 ...
 */
class BrMostrarreactivos extends \AppBundle\Entity\BrMostrarreactivos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BrMostrarreactivos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\BrMostrarreactivos' . "\0" . 'cantidad', '' . "\0" . 'AppBundle\\Entity\\BrMostrarreactivos' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BrMostrarreactivos' . "\0" . 'mostrarreactivosid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BrMostrarreactivos $proxy) {
    ...
    public function getMostrarreactivosid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMostrarreactivosid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMostrarreactivosid', []);

        return parent::getMostrarreactivosid();
    }
