 ...
 */
class BrSistemacalificacion extends \AppBundle\Entity\BrSistemacalificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BrSistemacalificacion' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\BrSistemacalificacion' . "\0" . 'inicio', '' . "\0" . 'AppBundle\\Entity\\BrSistemacalificacion' . "\0" . 'fin', '' . "\0" . 'AppBundle\\Entity\\BrSistemacalificacion' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BrSistemacalificacion' . "\0" . 'sistemacalificacionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BrSistemacalificacion $proxy) {
    ...
    public function getSistemacalificacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSistemacalificacionid();
        }
