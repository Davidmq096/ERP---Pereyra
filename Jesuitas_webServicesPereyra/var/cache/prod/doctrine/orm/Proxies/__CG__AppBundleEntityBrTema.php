 ...
 */
class BrTema extends \AppBundle\Entity\BrTema implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BrTema' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\BrTema' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\BrTema' . "\0" . 'temaid', '' . "\0" . 'AppBundle\\Entity\\BrTema' . "\0" . 'areaid', '' . "\0" . 'AppBundle\\Entity\\BrTema' . "\0" . 'materiaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BrTema $proxy) {
