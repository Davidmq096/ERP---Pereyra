 ...
 */
class CbAgendacitapadresotutores extends \AppBundle\Entity\CbAgendacitapadresotutores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CbAgendacitapadresotutores' . "\0" . 'otros', '' . "\0" . 'AppBundle\\Entity\\CbAgendacitapadresotutores' . "\0" . 'agendacitapadresotutoresid', '' . "\0" . 'AppBundle\\Entity\\CbAgendacitapadresotutores' . "\0" . 'agendacitaid', '' . "\0" . 'AppBundle\\Entity\\CbAgendacitapadresotutores' . "\0" . 'padresotutoresid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CbAgendacitapadresotutores $proxy) {
    ...
    public function getAgendacitapadresotutoresid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAgendacitapadresotutoresid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAgendacitapadresotutoresid', []);

        return parent::getAgendacitapadresotutoresid();
    }
    ...
    public function setAgendacitaid(\AppBundle\Entity\CbAgendacita $agendacitaid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAgendacitaid', [$agendacitaid]);

        return parent::setAgendacitaid($agendacitaid);
    }
