 ...
 */
class CbAlumnoporacuerdo extends \AppBundle\Entity\CbAlumnoporacuerdo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CbAlumnoporacuerdo' . "\0" . 'importe', '' . "\0" . 'AppBundle\\Entity\\CbAlumnoporacuerdo' . "\0" . 'alumnoporacuerdoid', '' . "\0" . 'AppBundle\\Entity\\CbAlumnoporacuerdo' . "\0" . 'acuerdoid', '' . "\0" . 'AppBundle\\Entity\\CbAlumnoporacuerdo' . "\0" . 'alumnoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CbAlumnoporacuerdo $proxy) {
    ...
    public function getAlumnoporacuerdoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnoporacuerdoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnoporacuerdoid', []);

        return parent::getAlumnoporacuerdoid();
    }
