 ...
 */
class CbBloqueomanual extends \AppBundle\Entity\CbBloqueomanual implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'bloqueomanualid', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'alumnoporcicloid', '' . "\0" . 'AppBundle\\Entity\\CbBloqueomanual' . "\0" . 'estatusbloqueoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CbBloqueomanual $proxy) {
    ...
    public function getBloqueomanualid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getBloqueomanualid();
        }
    ...
    public function setEstatusbloqueoid(\AppBundle\Entity\CbEstatusbloqueo $estatusbloqueoid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEstatusbloqueoid', [$estatusbloqueoid]);

        return parent::setEstatusbloqueoid($estatusbloqueoid);
    }
    ...
    public function getEstatusbloqueoid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEstatusbloqueoid', []);

        return parent::getEstatusbloqueoid();
    }
