 ...
 */
class CeAlumnociclofoto extends \AppBundle\Entity\CeAlumnociclofoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnociclofoto' . "\0" . 'foto', '' . "\0" . 'AppBundle\\Entity\\CeAlumnociclofoto' . "\0" . 'alumnociclofotoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnociclofoto' . "\0" . 'alumnoporcicloid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnociclofoto $proxy) {
    ...
    public function getAlumnociclofotoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnociclofotoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnociclofotoid', []);

        return parent::getAlumnociclofotoid();
    }
