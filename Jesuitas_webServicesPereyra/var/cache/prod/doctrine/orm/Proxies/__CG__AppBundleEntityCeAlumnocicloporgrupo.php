 ...
 */
class CeAlumnocicloporgrupo extends \AppBundle\Entity\CeAlumnocicloporgrupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnocicloporgrupo' . "\0" . 'numerolista', '' . "\0" . 'AppBundle\\Entity\\CeAlumnocicloporgrupo' . "\0" . 'alumnocicloporgrupo', '' . "\0" . 'AppBundle\\Entity\\CeAlumnocicloporgrupo' . "\0" . 'alumnoporcicloid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnocicloporgrupo' . "\0" . 'grupoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnocicloporgrupo $proxy) {
    ...
    public function getAlumnocicloporgrupo()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnocicloporgrupo();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnocicloporgrupo', []);

        return parent::getAlumnocicloporgrupo();
    }
