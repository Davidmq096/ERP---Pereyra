 ...
 */
class CeAlumnodatomedico extends \AppBundle\Entity\CeAlumnodatomedico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'padece', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'alergico', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'antecedentefamiliar', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'autorizoantihistaminico', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'examenvista', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'lentes', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'examenauditivo', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'aparatoauditivo', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'examenortopedicos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'aditamentoortopedico', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'peso', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'talla', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'enfermedadcronica', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'medicamentoregularidad', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'alergicosustancias', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'medicamentoadministrar', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'analgesicosantinflamatorios', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'antigripalesantihistaminicos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'antiacidos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'antiespasmodicos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'materialcuracion', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'unguentos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'remediosalternativos', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'nombreautoriza', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'firma', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'personaatiende', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'telefonopersonaatiende', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'contactoemergencianombre', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'contactoemergenciatelefono', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'contactoemergenciaemail', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'otraalergia', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'padeceenfermedadcuidanombre', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'padeceenfermedadcuidatelefono', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'padeceenfermedadcuidadescripcion', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'descripcionantecedenteimportante', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'alumnodatomedicoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'contactoemergenciaparentesco', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodatomedico' . "\0" . 'tiposangineo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnodatomedico $proxy) {
    ...
    public function setAditamentoortopedico($aditamentoortopedico)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAditamentoortopedico', [$aditamentoortopedico]);

        return parent::setAditamentoortopedico($aditamentoortopedico);
    }
    ...
    public function getAditamentoortopedico()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAditamentoortopedico', []);

        return parent::getAditamentoortopedico();
    }
    ...
    public function getAlumnodatomedicoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnodatomedicoid();
        }
    ...
    public function setTiposangineo(\AppBundle\Entity\Tiposanguineo $tiposangineo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTiposangineo', [$tiposangineo]);

        return parent::setTiposangineo($tiposangineo);
    }
    ...
    public function getTiposangineo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTiposangineo', []);

        return parent::getTiposangineo();
    }
