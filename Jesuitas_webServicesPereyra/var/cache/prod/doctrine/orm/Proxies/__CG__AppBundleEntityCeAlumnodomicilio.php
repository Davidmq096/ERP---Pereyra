 ...
 */
class CeAlumnodomicilio extends \AppBundle\Entity\CeAlumnodomicilio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'esfiscal', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'calle', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'numeroexterior', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'numerointerior', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'colonia', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'ciudad', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'codigopostal', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'alumnodomicilioid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnodomicilio' . "\0" . 'alumnoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnodomicilio $proxy) {
    ...
    public function setEsfiscal($esfiscal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEsfiscal', [$esfiscal]);

        return parent::setEsfiscal($esfiscal);
    }
    ...
    public function getEsfiscal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEsfiscal', []);

        return parent::getEsfiscal();
    }
    ...
    public function getAlumnodomicilioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnodomicilioid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnodomicilioid', []);

        return parent::getAlumnodomicilioid();
    }
