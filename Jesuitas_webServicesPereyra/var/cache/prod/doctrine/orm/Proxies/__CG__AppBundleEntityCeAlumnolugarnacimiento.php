 ...
 */
class CeAlumnolugarnacimiento extends \AppBundle\Entity\CeAlumnolugarnacimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnolugarnacimiento' . "\0" . 'alumnolugarnacimientoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnolugarnacimiento' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnolugarnacimiento' . "\0" . 'estadoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnolugarnacimiento' . "\0" . 'municipioid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnolugarnacimiento' . "\0" . 'paisid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnolugarnacimiento $proxy) {
    ...
    public function getAlumnolugarnacimientoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnolugarnacimientoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnolugarnacimientoid', []);

        return parent::getAlumnolugarnacimientoid();
    }
