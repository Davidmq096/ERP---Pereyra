 ...
 */
class CeAlumnoporclavefamiliar extends \AppBundle\Entity\CeAlumnoporclavefamiliar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporclavefamiliar' . "\0" . 'alumnoporclavefamiliar', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporclavefamiliar' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporclavefamiliar' . "\0" . 'clavefamiliarid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnoporclavefamiliar $proxy) {
    ...
    public function getAlumnoporclavefamiliar()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnoporclavefamiliar();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnoporclavefamiliar', []);

        return parent::getAlumnoporclavefamiliar();
    }
