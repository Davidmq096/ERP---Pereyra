 ...
 */
class CeAlumnoporsolicitudedicionextemporanea extends \AppBundle\Entity\CeAlumnoporsolicitudedicionextemporanea implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporsolicitudedicionextemporanea' . "\0" . 'alumnoporsolicitudedicionextemporaneaid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporsolicitudedicionextemporanea' . "\0" . 'solicitudedicionextemporaneaid', '' . "\0" . 'AppBundle\\Entity\\CeAlumnoporsolicitudedicionextemporanea' . "\0" . 'alumnoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAlumnoporsolicitudedicionextemporanea $proxy) {
    ...
    public function getAlumnoporsolicitudedicionextemporaneaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnoporsolicitudedicionextemporaneaid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnoporsolicitudedicionextemporaneaid', []);

        return parent::getAlumnoporsolicitudedicionextemporaneaid();
    }
