 ...
 */
class CeAreaacademica extends \AppBundle\Entity\CeAreaacademica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'areaacademicaid', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\CeAreaacademica' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAreaacademica $proxy) {
    ...
    public function getAreaacademicaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAreaacademicaid();
        }
