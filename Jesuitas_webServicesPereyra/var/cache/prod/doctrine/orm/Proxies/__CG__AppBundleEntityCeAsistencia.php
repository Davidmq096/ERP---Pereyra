 ...
 */
class CeAsistencia extends \AppBundle\Entity\CeAsistencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'hora', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'motivocancelacioninasistencia', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'fechamodificacion', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'asistenciaid', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'alumnoporcicloid', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'profesorpormateriaplanestudioid', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'estatusinasistenciaid', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'tipoasistenciaid', '' . "\0" . 'AppBundle\\Entity\\CeAsistencia' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAsistencia $proxy) {
    ...
    public function setMotivocancelacioninasistencia($motivocancelacioninasistencia)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMotivocancelacioninasistencia', [$motivocancelacioninasistencia]);

        return parent::setMotivocancelacioninasistencia($motivocancelacioninasistencia);
    }
    ...
    public function getMotivocancelacioninasistencia()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMotivocancelacioninasistencia', []);

        return parent::getMotivocancelacioninasistencia();
    }
