 ...
 */
class CeAsistenciaporpadreotutor extends \AppBundle\Entity\CeAsistenciaporpadreotutor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAsistenciaporpadreotutor' . "\0" . 'asistenciaporpadreotutorid', '' . "\0" . 'AppBundle\\Entity\\CeAsistenciaporpadreotutor' . "\0" . 'alumnoporcicloid', '' . "\0" . 'AppBundle\\Entity\\CeAsistenciaporpadreotutor' . "\0" . 'estatusinasistenciaid', '' . "\0" . 'AppBundle\\Entity\\CeAsistenciaporpadreotutor' . "\0" . 'juntapadreotutorid', '' . "\0" . 'AppBundle\\Entity\\CeAsistenciaporpadreotutor' . "\0" . 'tipoasistenciaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAsistenciaporpadreotutor $proxy) {
    ...
    public function getAsistenciaporpadreotutorid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAsistenciaporpadreotutorid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAsistenciaporpadreotutorid', []);

        return parent::getAsistenciaporpadreotutorid();
    }
    ...
    public function setJuntapadreotutorid(\AppBundle\Entity\CeJuntapadretutor $juntapadreotutorid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJuntapadreotutorid', [$juntapadreotutorid]);

        return parent::setJuntapadreotutorid($juntapadreotutorid);
    }
