 ...
 */
class CeAvisosplataforma extends \AppBundle\Entity\CeAvisosplataforma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'hora', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'avisoplataformaid', '' . "\0" . 'AppBundle\\Entity\\CeAvisosplataforma' . "\0" . 'avisoplataformaestatusid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeAvisosplataforma $proxy) {
    ...
    public function getAvisoplataformaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAvisoplataformaid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvisoplataformaid', []);

        return parent::getAvisoplataformaid();
    }
    ...
    public function setAvisoplataformaestatusid(\AppBundle\Entity\CeAvisosporcaratulaestatus $avisoplataformaestatusid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAvisoplataformaestatusid', [$avisoplataformaestatusid]);

        return parent::setAvisoplataformaestatusid($avisoplataformaestatusid);
    }
    ...
    public function getAvisoplataformaestatusid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvisoplataformaestatusid', []);

        return parent::getAvisoplataformaestatusid();
    }
