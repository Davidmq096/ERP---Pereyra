 ...
 */
class CeCapturaasistenciaalumno extends \AppBundle\Entity\CeCapturaasistenciaalumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeCapturaasistenciaalumno' . "\0" . 'asistencia', '' . "\0" . 'AppBundle\\Entity\\CeCapturaasistenciaalumno' . "\0" . 'capturaasistenciaalumnoid', '' . "\0" . 'AppBundle\\Entity\\CeCapturaasistenciaalumno' . "\0" . 'capturaalumnoporperiodoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeCapturaasistenciaalumno $proxy) {
    ...
    public function getCapturaasistenciaalumnoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCapturaasistenciaalumnoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCapturaasistenciaalumnoid', []);

        return parent::getCapturaasistenciaalumnoid();
    }
