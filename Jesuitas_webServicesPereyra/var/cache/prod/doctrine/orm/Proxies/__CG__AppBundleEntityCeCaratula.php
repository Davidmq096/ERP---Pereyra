 ...
 */
class CeCaratula extends \AppBundle\Entity\CeCaratula implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeCaratula' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeCaratula' . "\0" . 'criterioevaluacion', '' . "\0" . 'AppBundle\\Entity\\CeCaratula' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CeCaratula' . "\0" . 'caratulaid', '' . "\0" . 'AppBundle\\Entity\\CeCaratula' . "\0" . 'profesorpormateriaplanestudiosid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeCaratula $proxy) {
    ...
    public function getCaratulaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCaratulaid();
        }
