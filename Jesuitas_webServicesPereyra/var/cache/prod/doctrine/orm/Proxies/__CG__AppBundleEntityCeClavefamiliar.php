 ...
 */
class CeClavefamiliar extends \AppBundle\Entity\CeClavefamiliar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeClavefamiliar' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\CeClavefamiliar' . "\0" . 'apellidopaterno', '' . "\0" . 'AppBundle\\Entity\\CeClavefamiliar' . "\0" . 'apellidomaterno', '' . "\0" . 'AppBundle\\Entity\\CeClavefamiliar' . "\0" . 'clavefamiliarid', '' . "\0" . 'AppBundle\\Entity\\CeClavefamiliar' . "\0" . 'situacionfamiliarid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeClavefamiliar $proxy) {
    ...
    public function getClavefamiliarid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getClavefamiliarid();
        }
    ...
    public function setSituacionfamiliarid(\AppBundle\Entity\CeSituacionfamiliar $situacionfamiliarid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSituacionfamiliarid', [$situacionfamiliarid]);

        return parent::setSituacionfamiliarid($situacionfamiliarid);
    }
