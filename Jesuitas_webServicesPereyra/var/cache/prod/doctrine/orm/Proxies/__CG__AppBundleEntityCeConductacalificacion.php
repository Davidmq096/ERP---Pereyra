 ...
 */
class CeConductacalificacion extends \AppBundle\Entity\CeConductacalificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeConductacalificacion' . "\0" . 'calificacion', '' . "\0" . 'AppBundle\\Entity\\CeConductacalificacion' . "\0" . 'titular', '' . "\0" . 'AppBundle\\Entity\\CeConductacalificacion' . "\0" . 'conductacalificacionid', '' . "\0" . 'AppBundle\\Entity\\CeConductacalificacion' . "\0" . 'alumnocicloporgrupoid', '' . "\0" . 'AppBundle\\Entity\\CeConductacalificacion' . "\0" . 'periodoevaluacionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeConductacalificacion $proxy) {
    ...
    public function getConductacalificacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getConductacalificacionid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConductacalificacionid', []);

        return parent::getConductacalificacionid();
    }
    ...
    public function setAlumnocicloporgrupoid(\AppBundle\Entity\CeAlumnocicloporgrupo $alumnocicloporgrupoid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAlumnocicloporgrupoid', [$alumnocicloporgrupoid]);

        return parent::setAlumnocicloporgrupoid($alumnocicloporgrupoid);
    }
    ...
    public function getAlumnocicloporgrupoid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAlumnocicloporgrupoid', []);

        return parent::getAlumnocicloporgrupoid();
    }
