 ...
 */
class CeConfiguracionhorario extends \AppBundle\Entity\CeConfiguracionhorario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'horainicio', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'horafin', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'esclase', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'configuracionhorarioid', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionhorario' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeConfiguracionhorario $proxy) {
    ...
    public function setEsclase($esclase)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEsclase', [$esclase]);

        return parent::setEsclase($esclase);
    }
    ...
    public function getEsclase()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEsclase', []);

        return parent::getEsclase();
    }
    ...
    public function getConfiguracionhorarioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getConfiguracionhorarioid();
        }
