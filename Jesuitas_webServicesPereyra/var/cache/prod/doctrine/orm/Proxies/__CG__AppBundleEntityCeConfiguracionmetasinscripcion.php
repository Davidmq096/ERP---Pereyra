 ...
 */
class CeConfiguracionmetasinscripcion extends \AppBundle\Entity\CeConfiguracionmetasinscripcion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionmetasinscripcion' . "\0" . 'meta', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionmetasinscripcion' . "\0" . 'configuracionmetainscripcionid', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionmetasinscripcion' . "\0" . 'gradoid', '' . "\0" . 'AppBundle\\Entity\\CeConfiguracionmetasinscripcion' . "\0" . 'cicloid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeConfiguracionmetasinscripcion $proxy) {
    ...
    public function getConfiguracionmetainscripcionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getConfiguracionmetainscripcionid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConfiguracionmetainscripcionid', []);

        return parent::getConfiguracionmetainscripcionid();
    }
