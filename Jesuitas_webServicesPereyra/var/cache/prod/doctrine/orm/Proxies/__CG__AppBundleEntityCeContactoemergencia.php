 ...
 */
class CeContactoemergencia extends \AppBundle\Entity\CeContactoemergencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'contactoemergenciaid', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeContactoemergencia' . "\0" . 'parentescoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeContactoemergencia $proxy) {
