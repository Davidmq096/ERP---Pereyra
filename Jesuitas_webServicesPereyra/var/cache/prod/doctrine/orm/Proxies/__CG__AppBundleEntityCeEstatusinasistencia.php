 ...
 */
class CeEstatusinasistencia extends \AppBundle\Entity\CeEstatusinasistencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeEstatusinasistencia' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CeEstatusinasistencia' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeEstatusinasistencia' . "\0" . 'estatusinasistenciaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeEstatusinasistencia $proxy) {
    ...
    public function getEstatusinasistenciaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getEstatusinasistenciaid();
        }
