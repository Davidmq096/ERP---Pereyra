 ...
 */
class CeExtraordinario extends \AppBundle\Entity\CeExtraordinario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeExtraordinario' . "\0" . 'extraordinarioid', '' . "\0" . 'AppBundle\\Entity\\CeExtraordinario' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeExtraordinario' . "\0" . 'estatusextraordinarioid', '' . "\0" . 'AppBundle\\Entity\\CeExtraordinario' . "\0" . 'profesorpormateriaplanestudiosid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeExtraordinario $proxy) {
    ...
    public function getExtraordinarioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getExtraordinarioid();
        }
