 ...
 */
class CeIdioma extends \AppBundle\Entity\CeIdioma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeIdioma' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeIdioma' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeIdioma' . "\0" . 'idiomaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeIdioma $proxy) {
