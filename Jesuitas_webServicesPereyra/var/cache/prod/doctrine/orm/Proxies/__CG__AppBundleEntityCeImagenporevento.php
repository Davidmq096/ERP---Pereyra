 ...
 */
class CeImagenporevento extends \AppBundle\Entity\CeImagenporevento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'nombrearchivo', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'archivo', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'archivosize', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'archivotipo', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'imagenporeventoid', '' . "\0" . 'AppBundle\\Entity\\CeImagenporevento' . "\0" . 'eventoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeImagenporevento $proxy) {
    ...
    public function getImagenporeventoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getImagenporeventoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImagenporeventoid', []);

        return parent::getImagenporeventoid();
    }
