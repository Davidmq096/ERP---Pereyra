 ...
 */
class CeIntercambioporalumno extends \AppBundle\Entity\CeIntercambioporalumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeIntercambioporalumno' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\CeIntercambioporalumno' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\CeIntercambioporalumno' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\CeIntercambioporalumno' . "\0" . 'intercambioporalumnoid', '' . "\0" . 'AppBundle\\Entity\\CeIntercambioporalumno' . "\0" . 'alumnoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeIntercambioporalumno $proxy) {
    ...
    public function getIntercambioporalumnoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIntercambioporalumnoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIntercambioporalumnoid', []);

        return parent::getIntercambioporalumnoid();
    }
