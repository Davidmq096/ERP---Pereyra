 ...
 */
class CeMateriahorarioporsubgrupotaller extends \AppBundle\Entity\CeMateriahorarioporsubgrupotaller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeMateriahorarioporsubgrupotaller' . "\0" . 'salon', '' . "\0" . 'AppBundle\\Entity\\CeMateriahorarioporsubgrupotaller' . "\0" . 'materiahorariosubgrupotallerid', '' . "\0" . 'AppBundle\\Entity\\CeMateriahorarioporsubgrupotaller' . "\0" . 'materiaporhorarioid', '' . "\0" . 'AppBundle\\Entity\\CeMateriahorarioporsubgrupotaller' . "\0" . 'profesorpormateriaplanestudiosid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeMateriahorarioporsubgrupotaller $proxy) {
    ...
    public function getMateriahorariosubgrupotallerid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMateriahorariosubgrupotallerid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMateriahorariosubgrupotallerid', []);

        return parent::getMateriahorariosubgrupotallerid();
    }
    ...
    public function setMateriaporhorarioid(\AppBundle\Entity\CeMateriaporhorario $materiaporhorarioid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMateriaporhorarioid', [$materiaporhorarioid]);

        return parent::setMateriaporhorarioid($materiaporhorarioid);
    }
