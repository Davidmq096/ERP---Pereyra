 ...
 */
class CeNacionalidadporalumno extends \AppBundle\Entity\CeNacionalidadporalumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeNacionalidadporalumno' . "\0" . 'nacionalidadporalumnoid', '' . "\0" . 'AppBundle\\Entity\\CeNacionalidadporalumno' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeNacionalidadporalumno' . "\0" . 'nacionalidadid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeNacionalidadporalumno $proxy) {
    ...
    public function getNacionalidadporalumnoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getNacionalidadporalumnoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNacionalidadporalumnoid', []);

        return parent::getNacionalidadporalumnoid();
    }
