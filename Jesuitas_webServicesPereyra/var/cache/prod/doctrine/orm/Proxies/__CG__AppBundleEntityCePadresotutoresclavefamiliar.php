 ...
 */
class CePadresotutoresclavefamiliar extends \AppBundle\Entity\CePadresotutoresclavefamiliar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresclavefamiliar' . "\0" . 'padresotutoresporclavefamiliar', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresclavefamiliar' . "\0" . 'clavefamiliarid', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresclavefamiliar' . "\0" . 'padresotutoresid', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresclavefamiliar' . "\0" . 'tutorid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CePadresotutoresclavefamiliar $proxy) {
    ...
    public function getPadresotutoresporclavefamiliar()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPadresotutoresporclavefamiliar();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPadresotutoresporclavefamiliar', []);

        return parent::getPadresotutoresporclavefamiliar();
    }
