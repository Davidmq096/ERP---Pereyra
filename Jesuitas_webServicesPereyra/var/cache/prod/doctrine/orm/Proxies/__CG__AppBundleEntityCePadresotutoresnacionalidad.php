 ...
 */
class CePadresotutoresnacionalidad extends \AppBundle\Entity\CePadresotutoresnacionalidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresnacionalidad' . "\0" . 'padresotutoresnacionalidad', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresnacionalidad' . "\0" . 'nacionalidadid', '' . "\0" . 'AppBundle\\Entity\\CePadresotutoresnacionalidad' . "\0" . 'padresotutoresid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CePadresotutoresnacionalidad $proxy) {
    ...
    public function getPadresotutoresnacionalidad()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPadresotutoresnacionalidad();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPadresotutoresnacionalidad', []);

        return parent::getPadresotutoresnacionalidad();
    }
