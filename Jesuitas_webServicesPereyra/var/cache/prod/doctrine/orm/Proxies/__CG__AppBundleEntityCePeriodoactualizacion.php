 ...
 */
class CePeriodoactualizacion extends \AppBundle\Entity\CePeriodoactualizacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CePeriodoactualizacion' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\CePeriodoactualizacion' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\CePeriodoactualizacion' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CePeriodoactualizacion' . "\0" . 'periodoactualizacionid', '' . "\0" . 'AppBundle\\Entity\\CePeriodoactualizacion' . "\0" . 'cicloid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CePeriodoactualizacion $proxy) {
    ...
    public function getPeriodoactualizacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPeriodoactualizacionid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPeriodoactualizacionid', []);

        return parent::getPeriodoactualizacionid();
    }
