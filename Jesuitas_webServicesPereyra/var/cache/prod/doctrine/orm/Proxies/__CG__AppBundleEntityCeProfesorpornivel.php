 ...
 */
class CeProfesorpornivel extends \AppBundle\Entity\CeProfesorpornivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeProfesorpornivel' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeProfesorpornivel' . "\0" . 'profesorpornivelid', '' . "\0" . 'AppBundle\\Entity\\CeProfesorpornivel' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\CeProfesorpornivel' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\CeProfesorpornivel' . "\0" . 'profesorid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeProfesorpornivel $proxy) {
    ...
    public function getProfesorpornivelid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getProfesorpornivelid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProfesorpornivelid', []);

        return parent::getProfesorpornivelid();
    }
