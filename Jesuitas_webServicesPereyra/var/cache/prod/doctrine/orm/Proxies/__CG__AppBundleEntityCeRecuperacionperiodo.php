 ...
 */
class CeRecuperacionperiodo extends \AppBundle\Entity\CeRecuperacionperiodo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'intento', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'calificacion', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'recuperacionperiodoid', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'alumnoporcicloid', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'periodoevaluacionid', '' . "\0" . 'AppBundle\\Entity\\CeRecuperacionperiodo' . "\0" . 'profesorpormateriaplanestudioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeRecuperacionperiodo $proxy) {
    ...
    public function getRecuperacionperiodoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getRecuperacionperiodoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRecuperacionperiodoid', []);

        return parent::getRecuperacionperiodoid();
    }
