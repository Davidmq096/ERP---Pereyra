 ...
 */
class CeTalleropcionregistro extends \AppBundle\Entity\CeTalleropcionregistro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTalleropcionregistro' . "\0" . 'notalleres', '' . "\0" . 'AppBundle\\Entity\\CeTalleropcionregistro' . "\0" . 'prioridad', '' . "\0" . 'AppBundle\\Entity\\CeTalleropcionregistro' . "\0" . 'talleropcionregistroid', '' . "\0" . 'AppBundle\\Entity\\CeTalleropcionregistro' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTalleropcionregistro $proxy) {
    ...
    public function getTalleropcionregistroid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTalleropcionregistroid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTalleropcionregistroid', []);

        return parent::getTalleropcionregistroid();
    }
