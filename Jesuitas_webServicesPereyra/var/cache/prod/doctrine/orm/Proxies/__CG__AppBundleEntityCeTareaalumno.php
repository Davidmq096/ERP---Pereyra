 ...
 */
class CeTareaalumno extends \AppBundle\Entity\CeTareaalumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'entiempo', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'calificacion', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'tareaalumnoid', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CeTareaalumno' . "\0" . 'tareaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTareaalumno $proxy) {
    ...
    public function setEntiempo($entiempo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEntiempo', [$entiempo]);

        return parent::setEntiempo($entiempo);
    }
    ...
    public function getEntiempo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntiempo', []);

        return parent::getEntiempo();
    }
    ...
    public function getTareaalumnoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTareaalumnoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTareaalumnoid', []);

        return parent::getTareaalumnoid();
    }
