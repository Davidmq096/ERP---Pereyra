 ...
 */
class CeTareaarchivo extends \AppBundle\Entity\CeTareaarchivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'contenido', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'size', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'tareaarchivoid', '' . "\0" . 'AppBundle\\Entity\\CeTareaarchivo' . "\0" . 'tareaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTareaarchivo $proxy) {
    ...
    public function getTareaarchivoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTareaarchivoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTareaarchivoid', []);

        return parent::getTareaarchivoid();
    }
