 ...
 */
class CeTipoasistencia extends \AppBundle\Entity\CeTipoasistencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistencia' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistencia' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistencia' . "\0" . 'tipoasistenciaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTipoasistencia $proxy) {
    ...
    public function getTipoasistenciaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipoasistenciaid();
        }
