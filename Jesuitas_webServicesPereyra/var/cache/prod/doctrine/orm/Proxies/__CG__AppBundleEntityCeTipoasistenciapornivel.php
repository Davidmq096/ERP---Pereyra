 ...
 */
class CeTipoasistenciapornivel extends \AppBundle\Entity\CeTipoasistenciapornivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistenciapornivel' . "\0" . 'tipoasistenciaid', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistenciapornivel' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\CeTipoasistenciapornivel' . "\0" . 'tipoasistenciapornivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTipoasistenciapornivel $proxy) {
    ...
    public function getTipoasistenciapornivelid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipoasistenciapornivelid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoasistenciapornivelid', []);

        return parent::getTipoasistenciapornivelid();
    }
