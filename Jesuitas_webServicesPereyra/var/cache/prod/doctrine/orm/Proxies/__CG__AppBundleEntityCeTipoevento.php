 ...
 */
class CeTipoevento extends \AppBundle\Entity\CeTipoevento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CeTipoevento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CeTipoevento' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CeTipoevento' . "\0" . 'color', '' . "\0" . 'AppBundle\\Entity\\CeTipoevento' . "\0" . 'tipoeventoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CeTipoevento $proxy) {
    ...
    public function getTipoeventoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipoeventoid();
        }
