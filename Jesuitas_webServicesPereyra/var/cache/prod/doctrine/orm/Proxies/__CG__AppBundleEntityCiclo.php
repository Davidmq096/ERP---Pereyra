 ...
 */
class Ciclo extends \AppBundle\Entity\Ciclo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Ciclo' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Ciclo' . "\0" . 'actual', '' . "\0" . 'AppBundle\\Entity\\Ciclo' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Ciclo' . "\0" . 'siguiente', '' . "\0" . 'AppBundle\\Entity\\Ciclo' . "\0" . 'cicloid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ciclo $proxy) {
    ...
    public function setSiguiente($siguiente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSiguiente', [$siguiente]);

        return parent::setSiguiente($siguiente);
    }
    ...
    public function getSiguiente()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSiguiente', []);

        return parent::getSiguiente();
    }
