 ...
 */
class Cicloporusuario extends \AppBundle\Entity\Cicloporusuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cicloporusuario' . "\0" . 'cicloporusuarioid', '' . "\0" . 'AppBundle\\Entity\\Cicloporusuario' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\Cicloporusuario' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cicloporusuario $proxy) {
    ...
    public function getCicloporusuarioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCicloporusuarioid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCicloporusuarioid', []);

        return parent::getCicloporusuarioid();
    }
