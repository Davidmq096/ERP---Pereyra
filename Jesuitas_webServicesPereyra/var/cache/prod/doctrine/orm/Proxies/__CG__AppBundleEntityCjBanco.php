 ...
 */
class CjBanco extends \AppBundle\Entity\CjBanco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjBanco' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CjBanco' . "\0" . 'cuenta', '' . "\0" . 'AppBundle\\Entity\\CjBanco' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\CjBanco' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CjBanco' . "\0" . 'bancoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjBanco $proxy) {
