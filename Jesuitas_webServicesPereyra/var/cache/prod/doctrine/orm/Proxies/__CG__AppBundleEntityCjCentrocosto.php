 ...
 */
class CjCentrocosto extends \AppBundle\Entity\CjCentrocosto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjCentrocosto' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CjCentrocosto' . "\0" . 'alias', '' . "\0" . 'AppBundle\\Entity\\CjCentrocosto' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CjCentrocosto' . "\0" . 'centrocostoid', '' . "\0" . 'AppBundle\\Entity\\CjCentrocosto' . "\0" . 'empresaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjCentrocosto $proxy) {
    ...
    public function getCentrocostoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCentrocostoid();
        }
