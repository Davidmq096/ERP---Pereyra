 ...
 */
class CjConceptopornivel extends \AppBundle\Entity\CjConceptopornivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjConceptopornivel' . "\0" . 'conceptopornivelid', '' . "\0" . 'AppBundle\\Entity\\CjConceptopornivel' . "\0" . 'conceptoid', '' . "\0" . 'AppBundle\\Entity\\CjConceptopornivel' . "\0" . 'nivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjConceptopornivel $proxy) {
    ...
    public function getConceptopornivelid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getConceptopornivelid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConceptopornivelid', []);

        return parent::getConceptopornivelid();
    }
