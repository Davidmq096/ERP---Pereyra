 ...
 */
class CjCuentaporconcepto extends \AppBundle\Entity\CjCuentaporconcepto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjCuentaporconcepto' . "\0" . 'cuentaporconceptoid', '' . "\0" . 'AppBundle\\Entity\\CjCuentaporconcepto' . "\0" . 'bancoid', '' . "\0" . 'AppBundle\\Entity\\CjCuentaporconcepto' . "\0" . 'conceptoid', '' . "\0" . 'AppBundle\\Entity\\CjCuentaporconcepto' . "\0" . 'cuentacontableid', '' . "\0" . 'AppBundle\\Entity\\CjCuentaporconcepto' . "\0" . 'tipocuentaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjCuentaporconcepto $proxy) {
    ...
    public function getCuentaporconceptoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCuentaporconceptoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCuentaporconceptoid', []);

        return parent::getCuentaporconceptoid();
    }
    ...
    public function setTipocuentaid(\AppBundle\Entity\CjTipocuenta $tipocuentaid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipocuentaid', [$tipocuentaid]);

        return parent::setTipocuentaid($tipocuentaid);
    }
    ...
    public function getTipocuentaid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipocuentaid', []);

        return parent::getTipocuentaid();
    }
