 ...
 */
class CjFactura extends \AppBundle\Entity\CjFactura implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'serie', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'folio', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'rfc', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'razonsocial', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'importe', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'fechaemision', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'correo', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'calle', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'numeroexterior', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'numerointerior', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'colonia', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'ciudad', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'codigopostal', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'tipofactura', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'facturaid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'cajaid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'facturaestatusid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'padresotutoresid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'pagoid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'usuarioid', '' . "\0" . 'AppBundle\\Entity\\CjFactura' . "\0" . 'usocfdiid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjFactura $proxy) {
