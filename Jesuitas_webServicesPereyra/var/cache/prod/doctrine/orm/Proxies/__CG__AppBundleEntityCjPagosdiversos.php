 ...
 */
class CjPagosdiversos extends \AppBundle\Entity\CjPagosdiversos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjPagosdiversos' . "\0" . 'fechahora', '' . "\0" . 'AppBundle\\Entity\\CjPagosdiversos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CjPagosdiversos' . "\0" . 'pagodiversoid', '' . "\0" . 'AppBundle\\Entity\\CjPagosdiversos' . "\0" . 'subconceptoid', '' . "\0" . 'AppBundle\\Entity\\CjPagosdiversos' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjPagosdiversos $proxy) {
    ...
    public function getPagodiversoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPagodiversoid();
        }
