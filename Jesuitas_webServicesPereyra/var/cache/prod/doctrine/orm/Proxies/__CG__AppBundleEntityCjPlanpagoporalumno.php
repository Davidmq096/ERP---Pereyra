 ...
 */
class CjPlanpagoporalumno extends \AppBundle\Entity\CjPlanpagoporalumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjPlanpagoporalumno' . "\0" . 'planpagoporalumnoid', '' . "\0" . 'AppBundle\\Entity\\CjPlanpagoporalumno' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CjPlanpagoporalumno' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\CjPlanpagoporalumno' . "\0" . 'planpagoid', '' . "\0" . 'AppBundle\\Entity\\CjPlanpagoporalumno' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjPlanpagoporalumno $proxy) {
    ...
    public function getPlanpagoporalumnoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPlanpagoporalumnoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPlanpagoporalumnoid', []);

        return parent::getPlanpagoporalumnoid();
    }
