 ...
 */
class CjUsocfdi extends \AppBundle\Entity\CjUsocfdi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'fisica', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'moral', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\CjUsocfdi' . "\0" . 'usocfdiid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjUsocfdi $proxy) {
    ...
    public function setFisica($fisica)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFisica', [$fisica]);

        return parent::setFisica($fisica);
    }
    ...
    public function getFisica()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFisica', []);
    ...
    public function getUsocfdiid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUsocfdiid();
        }
