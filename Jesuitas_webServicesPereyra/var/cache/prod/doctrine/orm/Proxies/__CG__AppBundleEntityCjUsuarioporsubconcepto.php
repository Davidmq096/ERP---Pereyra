 ...
 */
class CjUsuarioporsubconcepto extends \AppBundle\Entity\CjUsuarioporsubconcepto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CjUsuarioporsubconcepto' . "\0" . 'usuarioporsubconceptoid', '' . "\0" . 'AppBundle\\Entity\\CjUsuarioporsubconcepto' . "\0" . 'subconceptoid', '' . "\0" . 'AppBundle\\Entity\\CjUsuarioporsubconcepto' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CjUsuarioporsubconcepto $proxy) {
    ...
    public function getUsuarioporsubconceptoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUsuarioporsubconceptoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsuarioporsubconceptoid', []);

        return parent::getUsuarioporsubconceptoid();
    }
