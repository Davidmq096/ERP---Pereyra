 ...
 */
class CmEventoleido extends \AppBundle\Entity\CmEventoleido implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'leido', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'eventoleidoid', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'eventoid', '' . "\0" . 'AppBundle\\Entity\\CmEventoleido' . "\0" . 'eventopornivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CmEventoleido $proxy) {
    ...
    public function getEventoleidoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getEventoleidoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEventoleidoid', []);

        return parent::getEventoleidoid();
    }
    ...
    public function setEventopornivelid(\AppBundle\Entity\CeEventopornivel $eventopornivelid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEventopornivelid', [$eventopornivelid]);

        return parent::setEventopornivelid($eventopornivelid);
    }
