 ...
 */
class Colonia extends \AppBundle\Entity\Colonia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'cp', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'coloniaid', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'municipioid'];
        }
    ...
    public function getColoniaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getColoniaid();
        }
