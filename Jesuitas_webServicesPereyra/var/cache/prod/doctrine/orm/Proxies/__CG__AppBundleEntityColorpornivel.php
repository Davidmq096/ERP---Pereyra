 ...
 */
class Colorpornivel extends \AppBundle\Entity\Colorpornivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Colorpornivel' . "\0" . 'color', '' . "\0" . 'AppBundle\\Entity\\Colorpornivel' . "\0" . 'colorpornivelid', '' . "\0" . 'AppBundle\\Entity\\Colorpornivel' . "\0" . 'nivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Colorpornivel $proxy) {
    ...
    public function getColorpornivelid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getColorpornivelid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getColorpornivelid', []);

        return parent::getColorpornivelid();
    }
