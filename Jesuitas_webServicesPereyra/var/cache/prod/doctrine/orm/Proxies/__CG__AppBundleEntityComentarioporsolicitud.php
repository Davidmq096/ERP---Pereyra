 ...
 */
class Comentarioporsolicitud extends \AppBundle\Entity\Comentarioporsolicitud implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comentarioporsolicitud' . "\0" . 'comentario', '' . "\0" . 'AppBundle\\Entity\\Comentarioporsolicitud' . "\0" . 'comentarioporsolicitudid', '' . "\0" . 'AppBundle\\Entity\\Comentarioporsolicitud' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Comentarioporsolicitud $proxy) {
    ...
    public function getComentarioporsolicitudid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getComentarioporsolicitudid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getComentarioporsolicitudid', []);

        return parent::getComentarioporsolicitudid();
    }
