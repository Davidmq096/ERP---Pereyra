 ...
 */
class Datoadjunto extends \AppBundle\Entity\Datoadjunto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Datoadjunto' . "\0" . 'contenido', '' . "\0" . 'AppBundle\\Entity\\Datoadjunto' . "\0" . 'size', '' . "\0" . 'AppBundle\\Entity\\Datoadjunto' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Datoadjunto' . "\0" . 'datoadjuntoid', '' . "\0" . 'AppBundle\\Entity\\Datoadjunto' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Datoadjunto $proxy) {
    ...
    public function getDatoadjuntoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDatoadjuntoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDatoadjuntoid', []);

        return parent::getDatoadjuntoid();
    }
