...
class Departamento extends \AppBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Departamento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Departamento' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Departamento' . "\0" . 'departamentoid'];
        }
