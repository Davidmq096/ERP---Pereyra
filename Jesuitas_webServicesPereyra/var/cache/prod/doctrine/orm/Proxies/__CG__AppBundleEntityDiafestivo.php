 ...
 */
class Diafestivo extends \AppBundle\Entity\Diafestivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Diafestivo' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Diafestivo' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\Diafestivo' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\Diafestivo' . "\0" . 'diafestivoid', '' . "\0" . 'AppBundle\\Entity\\Diafestivo' . "\0" . 'nivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Diafestivo $proxy) {
    ...
    public function getDiafestivoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDiafestivoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDiafestivoid', []);

        return parent::getDiafestivoid();
    }
