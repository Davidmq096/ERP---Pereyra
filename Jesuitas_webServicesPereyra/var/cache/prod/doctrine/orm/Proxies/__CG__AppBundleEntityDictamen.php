 ...
 */
class Dictamen extends \AppBundle\Entity\Dictamen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'dictamen', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'motivo', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'fecharegistro', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'dictamenid', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'solicitudadmisionid', '' . "\0" . 'AppBundle\\Entity\\Dictamen' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dictamen $proxy) {
    ...
    public function setDictamen($dictamen)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDictamen', [$dictamen]);

        return parent::setDictamen($dictamen);
    }
    ...
    public function getDictamen()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDictamen', []);

        return parent::getDictamen();
    }
    ...
    public function getDictamenid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDictamenid();
        }
