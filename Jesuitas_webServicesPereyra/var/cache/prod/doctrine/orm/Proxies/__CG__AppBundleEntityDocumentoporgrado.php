 ...
 */
class Documentoporgrado extends \AppBundle\Entity\Documentoporgrado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'original', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'copia', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'documentoporgradoid', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'documentoid', '' . "\0" . 'AppBundle\\Entity\\Documentoporgrado' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Documentoporgrado $proxy) {
    ...
    public function setCopia($copia)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCopia', [$copia]);

        return parent::setCopia($copia);
    }
    ...
    public function getCopia()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCopia', []);
    ...
    public function getDocumentoporgradoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDocumentoporgradoid();
        }
