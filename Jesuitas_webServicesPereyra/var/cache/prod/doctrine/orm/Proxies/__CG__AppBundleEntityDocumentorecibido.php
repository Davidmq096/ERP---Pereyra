 ...
 */
class Documentorecibido extends \AppBundle\Entity\Documentorecibido implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Documentorecibido' . "\0" . 'fecharegistro', '' . "\0" . 'AppBundle\\Entity\\Documentorecibido' . "\0" . 'documentorecibidoid', '' . "\0" . 'AppBundle\\Entity\\Documentorecibido' . "\0" . 'documentoid', '' . "\0" . 'AppBundle\\Entity\\Documentorecibido' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Documentorecibido $proxy) {
    ...
    public function getDocumentorecibidoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDocumentorecibidoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDocumentorecibidoid', []);

        return parent::getDocumentorecibidoid();
    }
