 ...
 */
class Estado extends \AppBundle\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Estado' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Estado' . "\0" . 'abreviatura', '' . "\0" . 'AppBundle\\Entity\\Estado' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Estado' . "\0" . 'estadoid', '' . "\0" . 'AppBundle\\Entity\\Estado' . "\0" . 'paisid'];
        }
