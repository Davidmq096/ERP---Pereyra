 ...
 */
class Evaluacionporgrado extends \AppBundle\Entity\Evaluacionporgrado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Evaluacionporgrado' . "\0" . 'evaluacionporgradoid', '' . "\0" . 'AppBundle\\Entity\\Evaluacionporgrado' . "\0" . 'evaluacionid', '' . "\0" . 'AppBundle\\Entity\\Evaluacionporgrado' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Evaluacionporgrado $proxy) {
    ...
    public function getEvaluacionporgradoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getEvaluacionporgradoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEvaluacionporgradoid', []);

        return parent::getEvaluacionporgradoid();
    }
