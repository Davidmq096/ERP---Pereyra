 ...
 */
class Grado extends \AppBundle\Entity\Grado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'grado', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'areaacademica', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'gradoid', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'semestreid', '' . "\0" . 'AppBundle\\Entity\\Grado' . "\0" . 'nivelid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Grado $proxy) {
    ...
    public function setAreaacademica($areaacademica)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAreaacademica', [$areaacademica]);

        return parent::setAreaacademica($areaacademica);
    }
    ...
    public function getAreaacademica()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAreaacademica', []);

        return parent::getAreaacademica();
    }
