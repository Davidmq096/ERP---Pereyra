 ...
 */
class Gradonivelporusuario extends \AppBundle\Entity\Gradonivelporusuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gradonivelporusuario' . "\0" . 'gradonivelporusuarioid', '' . "\0" . 'AppBundle\\Entity\\Gradonivelporusuario' . "\0" . 'gradoid', '' . "\0" . 'AppBundle\\Entity\\Gradonivelporusuario' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gradonivelporusuario $proxy) {
    ...
    public function getGradonivelporusuarioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getGradonivelporusuarioid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradonivelporusuarioid', []);

        return parent::getGradonivelporusuarioid();
    }
