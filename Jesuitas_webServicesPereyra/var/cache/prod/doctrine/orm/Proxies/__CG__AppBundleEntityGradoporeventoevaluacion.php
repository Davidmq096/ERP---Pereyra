 ...
 */
class Gradoporeventoevaluacion extends \AppBundle\Entity\Gradoporeventoevaluacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gradoporeventoevaluacion' . "\0" . 'gradoporeventoevaluacionid', '' . "\0" . 'AppBundle\\Entity\\Gradoporeventoevaluacion' . "\0" . 'eventoevaluacionid', '' . "\0" . 'AppBundle\\Entity\\Gradoporeventoevaluacion' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gradoporeventoevaluacion $proxy) {
    ...
    public function getGradoporeventoevaluacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getGradoporeventoevaluacionid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradoporeventoevaluacionid', []);

        return parent::getGradoporeventoevaluacionid();
    }
