 ...
 */
class Gradoporformato extends \AppBundle\Entity\Gradoporformato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gradoporformato' . "\0" . 'gradoporformatoid', '' . "\0" . 'AppBundle\\Entity\\Gradoporformato' . "\0" . 'formatoid', '' . "\0" . 'AppBundle\\Entity\\Gradoporformato' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gradoporformato $proxy) {
    ...
    public function getGradoporformatoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getGradoporformatoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradoporformatoid', []);

        return parent::getGradoporformatoid();
    }
