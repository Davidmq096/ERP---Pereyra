 ...
 */
class LuConfiguracion extends \AppBundle\Entity\LuConfiguracion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\LuConfiguracion' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\LuConfiguracion' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\LuConfiguracion' . "\0" . 'configuracionid', '' . "\0" . 'AppBundle\\Entity\\LuConfiguracion' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\LuConfiguracion' . "\0" . 'tipoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LuConfiguracion $proxy) {
    ...
    public function getConfiguracionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getConfiguracionid();
        }
