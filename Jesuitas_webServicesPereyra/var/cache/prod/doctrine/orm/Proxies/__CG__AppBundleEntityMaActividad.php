 ...
 */
class MaActividad extends \AppBundle\Entity\MaActividad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaActividad' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\MaActividad' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\MaActividad' . "\0" . 'actividadid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaActividad $proxy) {
