 ...
 */
class MaHigiene extends \AppBundle\Entity\MaHigiene implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaHigiene' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\MaHigiene' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\MaHigiene' . "\0" . 'higieneid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaHigiene $proxy) {
    ...
    public function getHigieneid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getHigieneid();
        }
