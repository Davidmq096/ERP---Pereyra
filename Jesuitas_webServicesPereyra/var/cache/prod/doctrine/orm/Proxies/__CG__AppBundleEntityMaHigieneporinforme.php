 ...
 */
class MaHigieneporinforme extends \AppBundle\Entity\MaHigieneporinforme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaHigieneporinforme' . "\0" . 'higieneporinformeid', '' . "\0" . 'AppBundle\\Entity\\MaHigieneporinforme' . "\0" . 'higieneid', '' . "\0" . 'AppBundle\\Entity\\MaHigieneporinforme' . "\0" . 'informeid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaHigieneporinforme $proxy) {
    ...
    public function getHigieneporinformeid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getHigieneporinformeid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHigieneporinformeid', []);

        return parent::getHigieneporinformeid();
    }
