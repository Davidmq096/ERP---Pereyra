 ...
 */
class MaInventariomarcado extends \AppBundle\Entity\MaInventariomarcado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaInventariomarcado' . "\0" . 'hecho', '' . "\0" . 'AppBundle\\Entity\\MaInventariomarcado' . "\0" . 'archivado', '' . "\0" . 'AppBundle\\Entity\\MaInventariomarcado' . "\0" . 'inventariomarcadoid', '' . "\0" . 'AppBundle\\Entity\\MaInventariomarcado' . "\0" . 'informeid', '' . "\0" . 'AppBundle\\Entity\\MaInventariomarcado' . "\0" . 'inventarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaInventariomarcado $proxy) {
    ...
    public function getInventariomarcadoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getInventariomarcadoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInventariomarcadoid', []);

        return parent::getInventariomarcadoid();
    }
    ...
    public function setInventarioid(\AppBundle\Entity\MaInventario $inventarioid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInventarioid', [$inventarioid]);

        return parent::setInventarioid($inventarioid);
    }
    ...
    public function getInventarioid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInventarioid', []);

        return parent::getInventarioid();
    }
