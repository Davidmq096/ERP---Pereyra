 ...
 */
class MaMenu extends \AppBundle\Entity\MaMenu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MaMenu' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\MaMenu' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\MaMenu' . "\0" . 'menuid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaMenu $proxy) {
