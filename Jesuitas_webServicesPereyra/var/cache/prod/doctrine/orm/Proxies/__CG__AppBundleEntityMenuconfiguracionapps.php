 ...
 */
class Menuconfiguracionapps extends \AppBundle\Entity\Menuconfiguracionapps implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'menuconfiguracionparentid', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'sistema', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Menuconfiguracionapps' . "\0" . 'menuconfiguracionappid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Menuconfiguracionapps $proxy) {
    ...
    public function getMenuconfiguracionappid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMenuconfiguracionappid();
        }
