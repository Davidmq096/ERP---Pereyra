 ...
 */
class Motivobaja extends \AppBundle\Entity\Motivobaja implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Motivobaja' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Motivobaja' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Motivobaja' . "\0" . 'motivobajaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Motivobaja $proxy) {
