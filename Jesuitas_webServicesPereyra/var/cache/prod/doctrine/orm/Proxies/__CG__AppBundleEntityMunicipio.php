...
class Municipio extends \AppBundle\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'municipioid', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'estadoid'];
        }
    ...
    public function getMunicipioid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMunicipioid();
        }
