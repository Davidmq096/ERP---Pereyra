 ...
 */
class Nacionalidadpordatoaspirante extends \AppBundle\Entity\Nacionalidadpordatoaspirante implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadpordatoaspirante' . "\0" . 'nacionalidadpordatoaspiranteid', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadpordatoaspirante' . "\0" . 'datoaspiranteid', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadpordatoaspirante' . "\0" . 'nacionalidad'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nacionalidadpordatoaspirante $proxy) {
