 ...
 */
class Nacionalidadporpadresotutores extends \AppBundle\Entity\Nacionalidadporpadresotutores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadporpadresotutores' . "\0" . 'nacionalidadporpadresotutoresid', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadporpadresotutores' . "\0" . 'nacionalidadid', '' . "\0" . 'AppBundle\\Entity\\Nacionalidadporpadresotutores' . "\0" . 'padresotutoresid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nacionalidadporpadresotutores $proxy) {
    ...
    public function getNacionalidadporpadresotutoresid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getNacionalidadporpadresotutoresid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNacionalidadporpadresotutoresid', []);

        return parent::getNacionalidadporpadresotutoresid();
    }
