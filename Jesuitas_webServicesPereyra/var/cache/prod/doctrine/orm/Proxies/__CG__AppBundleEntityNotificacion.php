 ...
 */
class Notificacion extends \AppBundle\Entity\Notificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'leido', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'tiponotificacionid', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'fechacreacion', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'fechaenvio', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'notificacionid', '' . "\0" . 'AppBundle\\Entity\\Notificacion' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Notificacion $proxy) {
    ...
    public function setTiponotificacionid($tiponotificacionid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTiponotificacionid', [$tiponotificacionid]);

        return parent::setTiponotificacionid($tiponotificacionid);
    }
    ...
    public function getTiponotificacionid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTiponotificacionid', []);

        return parent::getTiponotificacionid();
    }
