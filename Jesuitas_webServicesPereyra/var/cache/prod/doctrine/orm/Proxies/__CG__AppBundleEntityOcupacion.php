 ...
 */
class Ocupacion extends \AppBundle\Entity\Ocupacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Ocupacion' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\Ocupacion' . "\0" . 'clasificacion', '' . "\0" . 'AppBundle\\Entity\\Ocupacion' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Ocupacion' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Ocupacion' . "\0" . 'ocupacionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ocupacion $proxy) {
    ...
    public function getOcupacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getOcupacionid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOcupacionid', []);

        return parent::getOcupacionid();
    }
