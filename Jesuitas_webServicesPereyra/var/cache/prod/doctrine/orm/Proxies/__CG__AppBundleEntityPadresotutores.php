 ...
 */
class Padresotutores extends \AppBundle\Entity\Padresotutores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'ocupacion', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'apellidopaterno', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'apellidomaterno', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'celular', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'lugartrabajo', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'capturadordatos', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'autoriza', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'tutor', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'foto', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'curp', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'finado', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'fechanacimiento', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'especificacionocupacion', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'empresa', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'correo', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'telempresa', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'extencionempresa', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'horariotrabajo', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'exlux', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'ramo', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'alumnoinstituto', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'especificaralumno', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'tipoocupacion', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'padresotutoresid', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'nivelestudioid', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'generacionid', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'situacionconyugal', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'solicitudadmisionid', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'tutorid', '' . "\0" . 'AppBundle\\Entity\\Padresotutores' . "\0" . 'tiposanguineoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Padresotutores $proxy) {
    ...
    public function setFinado($finado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFinado', [$finado]);

        return parent::setFinado($finado);
    }
    ...
    public function getFinado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFinado', []);

        return parent::getFinado();
    }
    ...
    public function setExtencionempresa($extencionempresa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExtencionempresa', [$extencionempresa]);

        return parent::setExtencionempresa($extencionempresa);
    }
    ...
    public function getExtencionempresa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExtencionempresa', []);

        return parent::getExtencionempresa();
    }
    ...
    public function setTipoocupacion($tipoocupacion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoocupacion', [$tipoocupacion]);

        return parent::setTipoocupacion($tipoocupacion);
    }
    ...
    public function getTipoocupacion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoocupacion', []);

        return parent::getTipoocupacion();
    }
    ...
    public function setSituacionconyugal(\AppBundle\Entity\Situacionconyugal $situacionconyugal = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSituacionconyugal', [$situacionconyugal]);

        return parent::setSituacionconyugal($situacionconyugal);
    }
    ...
    public function getSituacionconyugal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSituacionconyugal', []);

        return parent::getSituacionconyugal();
    }
