 ...
 */
class Pantalla extends \AppBundle\Entity\Pantalla implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'identificador', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'pantallaid', '' . "\0" . 'AppBundle\\Entity\\Pantalla' . "\0" . 'submoduloid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pantalla $proxy) {
    ...
    public function getPantallaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPantallaid();
        }
    ...
    public function setSubmoduloid(\AppBundle\Entity\Submodulo $submoduloid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubmoduloid', [$submoduloid]);

        return parent::setSubmoduloid($submoduloid);
    }
