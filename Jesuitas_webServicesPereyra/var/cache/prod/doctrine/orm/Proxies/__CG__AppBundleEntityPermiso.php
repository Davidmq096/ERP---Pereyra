 ...
 */
class Permiso extends \AppBundle\Entity\Permiso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Permiso' . "\0" . 'identificador', '' . "\0" . 'AppBundle\\Entity\\Permiso' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Permiso' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Permiso' . "\0" . 'permisoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Permiso $proxy) {
    ...
    public function getPermisoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPermisoid();
        }
