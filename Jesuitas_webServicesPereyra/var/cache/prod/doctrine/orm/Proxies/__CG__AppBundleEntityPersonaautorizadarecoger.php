 ...
 */
class Personaautorizadarecoger extends \AppBundle\Entity\Personaautorizadarecoger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Personaautorizadarecoger' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Personaautorizadarecoger' . "\0" . 'personaautorizadarecoger', '' . "\0" . 'AppBundle\\Entity\\Personaautorizadarecoger' . "\0" . 'datoaspiranteid', '' . "\0" . 'AppBundle\\Entity\\Personaautorizadarecoger' . "\0" . 'parentescoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Personaautorizadarecoger $proxy) {
    ...
    public function getPersonaautorizadarecoger()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPersonaautorizadarecoger();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPersonaautorizadarecoger', []);

        return parent::getPersonaautorizadarecoger();
    }
