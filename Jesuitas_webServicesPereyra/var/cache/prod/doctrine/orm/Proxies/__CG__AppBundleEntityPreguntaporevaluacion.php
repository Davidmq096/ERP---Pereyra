 ...
 */
class Preguntaporevaluacion extends \AppBundle\Entity\Preguntaporevaluacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Preguntaporevaluacion' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\Preguntaporevaluacion' . "\0" . 'preguntaporevaluacionid', '' . "\0" . 'AppBundle\\Entity\\Preguntaporevaluacion' . "\0" . 'evaluacionid', '' . "\0" . 'AppBundle\\Entity\\Preguntaporevaluacion' . "\0" . 'preguntaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Preguntaporevaluacion $proxy) {
    ...
    public function getPreguntaporevaluacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPreguntaporevaluacionid();
        }
