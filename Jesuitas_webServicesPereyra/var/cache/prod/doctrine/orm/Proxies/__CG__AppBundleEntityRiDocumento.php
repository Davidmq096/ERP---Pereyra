 ...
 */
class RiDocumento extends \AppBundle\Entity\RiDocumento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'extension', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'tamano', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'documento', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\RiDocumento' . "\0" . 'documentoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RiDocumento $proxy) {
