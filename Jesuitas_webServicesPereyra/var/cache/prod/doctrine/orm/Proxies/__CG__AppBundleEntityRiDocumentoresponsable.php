 ...
 */
class RiDocumentoresponsable extends \AppBundle\Entity\RiDocumentoresponsable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'apellidopaterno', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'apellidomaterno', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'cp', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'colonia', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'calle', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'numeroext', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'numeroint', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'celular', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'ocupacion', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'edad', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'responsablecontratoid', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'reinscripcionid', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'documentoid', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'estadoid', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'municipioid', '' . "\0" . 'AppBundle\\Entity\\RiDocumentoresponsable' . "\0" . 'tutorid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RiDocumentoresponsable $proxy) {
