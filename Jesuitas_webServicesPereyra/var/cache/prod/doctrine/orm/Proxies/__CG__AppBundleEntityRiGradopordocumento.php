 ...
 */
class RiGradopordocumento extends \AppBundle\Entity\RiGradopordocumento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RiGradopordocumento' . "\0" . 'gradopordocumento', '' . "\0" . 'AppBundle\\Entity\\RiGradopordocumento' . "\0" . 'documentoid', '' . "\0" . 'AppBundle\\Entity\\RiGradopordocumento' . "\0" . 'gradoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RiGradopordocumento $proxy) {
    ...
    public function getGradopordocumento()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getGradopordocumento();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGradopordocumento', []);

        return parent::getGradopordocumento();
    }
