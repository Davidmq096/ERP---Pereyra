 ...
 */
class Solicitudadmisionporciclo extends \AppBundle\Entity\Solicitudadmisionporciclo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Solicitudadmisionporciclo' . "\0" . 'solicitudadmisionporcicloid', '' . "\0" . 'AppBundle\\Entity\\Solicitudadmisionporciclo' . "\0" . 'cicloid', '' . "\0" . 'AppBundle\\Entity\\Solicitudadmisionporciclo' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Solicitudadmisionporciclo $proxy) {
    ...
    public function getSolicitudadmisionporcicloid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSolicitudadmisionporcicloid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSolicitudadmisionporcicloid', []);

        return parent::getSolicitudadmisionporcicloid();
    }
