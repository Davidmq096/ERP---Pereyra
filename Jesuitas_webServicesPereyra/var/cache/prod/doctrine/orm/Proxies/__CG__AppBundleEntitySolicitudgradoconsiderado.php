 ...
 */
class Solicitudgradoconsiderado extends \AppBundle\Entity\Solicitudgradoconsiderado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Solicitudgradoconsiderado' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\Solicitudgradoconsiderado' . "\0" . 'solicitudgradoconsideradoid', '' . "\0" . 'AppBundle\\Entity\\Solicitudgradoconsiderado' . "\0" . 'nivelid', '' . "\0" . 'AppBundle\\Entity\\Solicitudgradoconsiderado' . "\0" . 'solicitudadmisionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Solicitudgradoconsiderado $proxy) {
    ...
    public function getSolicitudgradoconsideradoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSolicitudgradoconsideradoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSolicitudgradoconsideradoid', []);

        return parent::getSolicitudgradoconsideradoid();
    }
