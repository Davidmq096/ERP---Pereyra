 ...
 */
class Tipoevaluacion extends \AppBundle\Entity\Tipoevaluacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tipoevaluacion' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Tipoevaluacion' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Tipoevaluacion' . "\0" . 'color', '' . "\0" . 'AppBundle\\Entity\\Tipoevaluacion' . "\0" . 'mostrar', '' . "\0" . 'AppBundle\\Entity\\Tipoevaluacion' . "\0" . 'tipoevaluacionid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipoevaluacion $proxy) {
    ...
    public function getTipoevaluacionid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipoevaluacionid();
        }
