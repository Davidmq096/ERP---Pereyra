 ...
 */
class Tipopregunta extends \AppBundle\Entity\Tipopregunta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tipopregunta' . "\0" . 'tipopregunta', '' . "\0" . 'AppBundle\\Entity\\Tipopregunta' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Tipopregunta' . "\0" . 'tipopreguntaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipopregunta $proxy) {
    ...
    public function getTipopreguntaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTipopreguntaid();
        }
