 ...
 */
class TpAlumnoruta extends \AppBundle\Entity\TpAlumnoruta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TpAlumnoruta' . "\0" . 'alumnorutaid', '' . "\0" . 'AppBundle\\Entity\\TpAlumnoruta' . "\0" . 'alumnoid', '' . "\0" . 'AppBundle\\Entity\\TpAlumnoruta' . "\0" . 'contratoid', '' . "\0" . 'AppBundle\\Entity\\TpAlumnoruta' . "\0" . 'rutaid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TpAlumnoruta $proxy) {
    ...
    public function getAlumnorutaid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAlumnorutaid();
        }
