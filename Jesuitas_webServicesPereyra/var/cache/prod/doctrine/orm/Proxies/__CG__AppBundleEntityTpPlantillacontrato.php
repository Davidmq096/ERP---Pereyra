 ...
 */
class TpPlantillacontrato extends \AppBundle\Entity\TpPlantillacontrato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'contenido', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'size', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\TpPlantillacontrato' . "\0" . 'plantillacontratoid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TpPlantillacontrato $proxy) {
    ...
    public function getPlantillacontratoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPlantillacontratoid();
        }
