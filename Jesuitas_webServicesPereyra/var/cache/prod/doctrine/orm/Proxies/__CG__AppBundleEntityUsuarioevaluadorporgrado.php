 ...
 */
class Usuarioevaluadorporgrado extends \AppBundle\Entity\Usuarioevaluadorporgrado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuarioevaluadorporgrado' . "\0" . 'usuarioevaluadorporgradoid', '' . "\0" . 'AppBundle\\Entity\\Usuarioevaluadorporgrado' . "\0" . 'gradoid', '' . "\0" . 'AppBundle\\Entity\\Usuarioevaluadorporgrado' . "\0" . 'usuarioid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Usuarioevaluadorporgrado $proxy) {
    ...
    public function getUsuarioevaluadorporgradoid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUsuarioevaluadorporgradoid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsuarioevaluadorporgradoid', []);

        return parent::getUsuarioevaluadorporgradoid();
    }
