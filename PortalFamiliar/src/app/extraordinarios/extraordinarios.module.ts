...
import {ExtraordinariosComponent} from "./extraordinarios.component";
...
const routes: Routes =
  [
    {path: '', component:ExtraordinariosComponent},
...
export class ExtraordinariosModule
{
}
