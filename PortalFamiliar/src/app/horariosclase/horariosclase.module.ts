...
import {HorariosClaseComponent} from "./horariosclase.component";
...
const routes: Routes =
  [
    {path: '', component:HorariosClaseComponent},
    {path: 'horarioalumno', component:HorariosAlumnoComponent},
...
export class HorariosclaseModule
{
}
